...
type WalletAPI interface {
	...
	*/
	...
	/*
	V1AdminWalletsGet Get Wallets

	Get wallets

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return WalletAPIV1AdminWalletsGetRequest
	*/
	V1AdminWalletsGet(ctx context.Context) WalletAPIV1AdminWalletsGetRequest

	// V1AdminWalletsGetExecute executes the request
	//  @return []WalletWalletResponse
	V1AdminWalletsGetExecute(r WalletAPIV1AdminWalletsGetRequest) ([]WalletWalletResponse, *http.Response, error)
...
type WalletAPIV1AdminWalletsGetRequest struct {
	ctx context.Context
	ApiService WalletAPI
}

func (r WalletAPIV1AdminWalletsGetRequest) Execute() ([]WalletWalletResponse, *http.Response, error) {
	return r.ApiService.V1AdminWalletsGetExecute(r)
}
...
Get wallets
 ...
 @return WalletAPIV1AdminWalletsGetRequest
*/
func (a *WalletAPIService) V1AdminWalletsGet(ctx context.Context) WalletAPIV1AdminWalletsGetRequest {
	return WalletAPIV1AdminWalletsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []WalletWalletResponse
func (a *WalletAPIService) V1AdminWalletsGetExecute(r WalletAPIV1AdminWalletsGetRequest) ([]WalletWalletResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WalletAPIService.V1AdminWalletsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/admin/wallets"
